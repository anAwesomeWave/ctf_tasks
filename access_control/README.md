...
## Описание уязвимости
Класс уязвимостей Broken Access Control относится к ситуации, когда механизм контроля доступа к ресурсам 
работает некорректно и недостаточно строго контролирует, 
какие действия или ресурсы доступны пользователям сервиса. 
Это позволяет злоумышленникам получить несанкционированный доступ к данным или действиям.
